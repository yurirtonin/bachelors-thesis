...
#    def histograms(self):
    #        gaussian_numbers = np.random.normal(size=1000)
            ...
            plt.figure(10)
            plt.hist(croped_pixel_array,bins=bins,label='Data',alpha=0.3)

            plt.hist(self.X0_array/np.amax(self.X0_array),bins=bins,label='X_2',alpha=0.3)
            plt.hist(self.Y0_array/np.amax(self.Y0_array),bins=bins,label='Y_2',alpha=0.3)
            plt.hist(self.X1_array/np.amax(self.X1_array),bins=bins,label='X_10',alpha=0.5)
            plt.hist(self.Y1_array/np.amax(self.Y1_array),bins=bins,label='Y_10',alpha=0.5)
#            plt.hist(self.difference_list/np.amax(self.difference_list),bins=bins,label="Dif")
            plt.legend()
