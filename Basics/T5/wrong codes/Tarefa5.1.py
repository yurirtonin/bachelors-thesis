...
density_array = np.zeros(21)
density_array[5] = 1.0
density_array[15] = 1.0
...
plt.figure(3)
plt.plot(frequency_FT,FT)
#plt.legend()
#plt.axis([0.995*peak_frequencies[0],1.005*peak_frequencies[-1],-0.05,1.7])
