...
\usepackage[round]{natbib} %Citação (Nome,Ano). Deve usar \bibliographystyle{plainnat}
...
\newexperiment{reading}{Leitura de artigo}
...
\labday{Sexta, 10 de novembro de 2017}
...
\labday{Terça, 14 de novembro de 2017}
...
\labday{Quinta, 23 de novembro de 2017}
...
\labday{Terça, 28 de novembro de 2017}
...
\labday{Segunda, 4 de dezembro de 2017}
...
\bibliographystyle{plainnat} %Usar apenas em citação não numérica. Use \citet{} para: NOME (ANO). Use \citep{} para: (NOME, ANO)
\bibliography{A_bibliografia}
